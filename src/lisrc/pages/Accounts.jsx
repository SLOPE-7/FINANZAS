...
export default function Accounts() {
  ...
  // El patrimonio no suma tarjetas archivadas ni cuentas ocultas.
...
function AccountRow({ account: a, onEdit, onArchive, onUnarchive, onDelete }) {
  ...
  // En tarjetas el saldo negativo es lo normal (deuda), así que no
  // lo pintamos de rojo salvo que sea un banco en descubierto.
